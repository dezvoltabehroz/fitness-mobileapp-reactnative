        ...
        return (
            <Modal isVisible={isVisible}
                ...
                <View style={styles.modalLowerFilterContainer}>
                    <RNBounceable onPress={() => reOrder()} style={{ flexDirection: "row", justifyContent: "space-between", paddingVertical: "5%", paddingHorizontal: "5%" }}>
                        <View style={{ flexDirection: "row", alignItems: "center" }}>
                            <Icon.FontAwesome name="unsorted" color={"#FFFFFF"} size={25} />
                            <Text style={[styles.headingTextStyle, { marginLeft: 15 }]}>{"Re-order Exercises"}</Text>
                        </View>
                        <Icon.Entypo name="chevron-right" color={"#FFFFFF"} size={25} />
                    </RNBounceable>
                    <RNBounceable onPress={() => quitSession()} style={{ flexDirection: "row", justifyContent: "space-between", paddingVertical: "5%", paddingHorizontal: "5%" }}>
                        <View style={{ flexDirection: "row", alignItems: "center" }}>
                            <Icon.Entypo name="cross" color="white" size={25} />
                            <Text style={[styles.headingTextStyle, { marginLeft: 15 }]}>{"Quit Session"}</Text>
                        </View>
