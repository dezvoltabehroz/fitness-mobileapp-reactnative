...
export default StyleSheet.create({
    ...
    itemTextStyle: { fontWeight: "bold", paddingRight: 5 },
    ...
    itemContainer: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", elevation: 2, marginVertical: 15, marginHorizontal: "5%" },
    modalLowerContainer: {
        flex: 0.8,
