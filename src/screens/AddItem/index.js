...
class AddItem extends Component {
    ...
    handleSaveFunction = () => {
        ...
        if (name && calcium && calories && polyunsaturatedFat && monosaturatedFat && vitaminC && vitaminA && servingSize && saturatedFat &&
            sugars && potassium && sodium && carbohydrates && cholesterol && dietaryFiber && fat && iron && protein) {
            if (unitMeasurementId || selectedUnitMeasurement.id) {
                let userData = {
                    itemName: name,
